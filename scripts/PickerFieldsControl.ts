...
export class Controller {
    ...
    private _initialize(): void {
        ...
        WorkItemFormService.getService().then(
            async (service) => {
                let fields = await service.getFieldValues([this._fieldValue1, this._fieldValue2, this._fieldValue3, this._fieldValue4, this._summarizeToPath])
                spread(
                    [
                        this._controlName,
                        this._reposetory,
                    ...
                    (controlName: string, reposetory: string, viewOption: string,
                        fieldName1: string, fieldValue1: string, fieldRefName1: string, fieldHide1: string,
                        fieldName2: string, fieldValue2: string, fieldRefName2: string, fieldHide2: string,
                        fieldName3: string, fieldValue3: string, fieldRefName3: string, fieldHide3: string,
                        fieldName4: string, fieldValue4: string, fieldRefName4: string, fieldHide4: string,
                        ...
                        RetriveValueList(controlName, projectName).then((doc) => {
                            this._model = new Model(controlName, doc, reposetory, viewOption,
                                fieldName1, fieldValue1, fieldRefName1, fieldHide1,
                                fieldName2, fieldValue2, fieldRefName2, fieldHide2,
                                fieldName3, fieldValue3, fieldRefName3, fieldHide3,
                                fieldName4, fieldValue4, fieldRefName4, fieldHide4,
